...
<p align="center">
  <img src="src/assets/banner.jpeg" alt="UI demo banner" width="600" />
</p>

<div align="center">
  <a href="https://hardsoncore.github.io/js-interviewer">
    <img src="src/assets/button.png" alt="▶ PLAY NOW" width="200" style="image-rendering: pixelated;" />
  </a>
  <br>
  <em>No install, no sign-up — open and start practicing.</em>
</div>
...
## 💡 The solution: Pareto-driven answers
...
1. First pass — read the Cores.
2. Second pass — unfold the Deep Dives.
3. Night before the interview — skim the Cores again. Done.
...
<details>
<summary><b>📱 How to add it to your home screen</b></summary>
<br>

**iOS (Safari):** open the [app link](https://hardsoncore.github.io/js-interviewer) → tap **Share** → **Add to Home Screen**.

**Android (Chrome):** open the [app link](https://hardsoncore.github.io/js-interviewer) → tap **⋮** menu → **Add to Home screen**.
...
**Yehor Niestierov** — [@hardsoncore](https://github.com/hardsoncore)
