...
export const questions = [
  {
    ...
    structure: [
      ...
      {
        name: 'JavaScript блокує парсинг (defer / async)',
      },
      {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Зовнішній файл: тег link',
      },
      {
        name: 'Вбудовані стилі: тег style',
      },
      {
        name: 'Inline-стилі: атрибут style',
      },
      {
        name: 'Імпорт всередині CSS: @import',
      },
      {
        name: 'Стилі через JavaScript',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Що таке псевдоклас і чим він відрізняється від псевдоелемента',
      },
      {
        name: 'Псевдокласи стану (інтерактив): :hover, :focus, :focus-visible',
      },
      {
        name: 'Структурні псевдокласи: :nth-child і лічба серед сусідів',
      },
      {
        name: 'Функціональні псевдокласи: :is(), :where(), :not(), :has()',
      },
      {
        name: 'Псевдокласи форм: :checked, :valid, :user-invalid, :placeholder-shown',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Тип елемента задає display, а не тег',
      },
      {
        name: 'Блочні (block): свій рядок, працюють розміри та margin',
      },
      {
        name: 'Рядкові (inline): width/height і вертикальні margin ігноруються',
      },
      {
        name: 'inline-block — гібрид і проміжок 4px',
      },
      {
        name: 'Інші значення display: none, flex/grid, contents',
      },
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Суть: анімація — той самий CRP на кожному кадрі, анімуємо лише transform і opacity',
      },
      {
        name: 'Три етапи конвеєра (Layout, Paint, Composite) і правило каскаду',
      },
      {
        name: 'Бюджет кадра: 60 FPS і 16.7 мс',
      },
      {
        name: 'Практика: погано через геометрію, добре через transform, will-change',
      },
      {
        name: 'Під капотом',
      },
  ...
  },
  {
    ...
    structure: [
      {
        name: 'ToPrimitive: як об\'єкт перетворюється на примітив',
      },
      {
        name: 'Три хінти (string, number, default) і порядок виклику valueOf/toString',
      },
      {
        name: 'Поведінка за замовчуванням: чому виходить "[object Object]"',
      },
      {
        name: 'Кастомізація: власні toString/valueOf і Symbol.toPrimitive',
      },
      {
        name: 'Пастка: один toString() покриває обидва контексти, а valueOf — ні',
      }
    ]
  },
  {
    ...
    structure: [
      {
        name: 'Навіщо потрібен Event Loop: однопотоковість і Call Stack',
      },
      {
        name: 'Учасники: Call Stack, Web APIs, Macrotask і Microtask Queue',
      },
      {
        name: 'Алгоритм одного тіку',
      },
      {
        name: 'Формула: синхронний код → ВСІ мікротаски → рендер → ОДИН макротаск',
      },
      {
        name: 'Класична задача на порядок виводу (setTimeout 0 vs Promise)',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: '__proto__ — історичний аксесор до [[Prototype]]',
      },
      {
        name: '__proto__ vs [[Prototype]] vs F.prototype',
      },
      {
        name: 'Сучасні альтернативи: Object.getPrototypeOf / setPrototypeOf / create',
      },
      {
        name: 'Продуктивність: чому не можна змінювати прототип на льоту',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Що таке ES6 і чому це головне оновлення мови',
      },
      {
        name: 'Змінні: let, const і Temporal Dead Zone',
      },
      {
        name: 'Новий синтаксис: стрілки, шаблонні рядки, деструктуризація, spread/rest',
      },
      {
        name: 'Структура коду: класи як цукор над прототипами і модулі import/export',
      },
      {
        name: 'Асинхронність і нові типи: Promise, Map, Set, Symbol, генератори',
      },
      {
        name: 'Що помилково приписують ES6: async/await, spread об\'єктів, поля класу',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Паттерн — типове рішення і спільна мова команди',
      },
      {
        name: 'Породжувальні: Singleton, Factory Method, Builder',
      },
      {
        name: 'Структурні: Adapter, Decorator, Facade, Proxy',
      },
      {
        name: 'Поведінкові: Observer, Strategy, Command',
      },
      {
        name: 'Паттерни у фронтенд-стеку: DI-сервіси, RxJS, декоратори, Proxy у Vue 3',
      },
      {
        name: 'Пастка: overengineering — паттерн застосовують до проблеми',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Вимоги специфікації ECMAScript 2019 (ES10) до стабільності Array.prototype.sort()',
      },
      {
        name: 'Timsort - гібридне сортування. Як воно працює і чому використовується в сучасних движках JavaScript',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Приклади Higher-Order Functions в JavaScript (map, filter, reduce, sort і т.д.)',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Синглтони підветви роутів в Standalone-компонентах',
      }
    ]
  },
  {
