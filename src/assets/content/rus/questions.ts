...
export const questions = [
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Семантическая вёрстка: что это и зачем',
      },
      {
        name: 'Основные семантические теги HTML5',
      },
      {
        name: 'article vs section vs div',
      },
      {
        name: 'Доступность и ARIA',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Содержащий блок и stacking context',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'F.prototype — свойство функции, шаблон прототипа для экземпляров',
      },
      {
        name: 'Четыре шага оператора new',
      },
      {
        name: 'Свойство constructor и обратная ссылка на функцию',
      },
      {
        name: 'Ловушки: перезапись прототипа vs мутация, потеря constructor',
      }
    ]
  },
  {
    ...
    structure: [
      {
        name: 'Promise — обёртка над результатом асинхронной операции (ES6)',
      },
      {
        name: 'Какую проблему решали: Callback Hell и разрозненная обработка ошибок',
      },
      {
        name: 'Три состояния: pending, fulfilled, rejected',
      },
      {
        name: 'Результат замораживается навсегда (settled)',
      },
      {
        name: 'then, catch, finally и новый промис на выходе',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Что это и зачем: catch ловит только синхронно брошенное',
      },
      {
        name: 'Механика: throw и раскрутка стека вызовов',
      },
      {
        name: 'Синтаксис, объект ошибки и throw своих ошибок',
      },
      {
        name: 'Блок finally',
      },
      {
        name: 'Ловушка: асинхронные ошибки и try/catch вокруг await',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'async/await — синтаксический сахар над промисами (ES2017)',
      },
      {
        name: 'Какую проблему решают: шум и ветвление цепочек .then()',
      },
      {
        name: 'async: наружу всегда промис; await: пауза функции без блокировки потока',
      },
      {
        name: 'Обработка ошибок: reject становится исключением для try...catch...finally',
      },
      {
        name: 'Ловушка: последовательные await вместо параллельного Promise.all',
      }
    ]
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Ловушка: ошибка в all не отменяет остальные промисы',
      }
    ]
  },
  {
  ...
  {
    id: 62,
    name: 'LocalStorage VS SessionStorage. Различия, принцип работы. Когда использовать?',
    ...
    structure: [
      {
        name: 'Общий принцип: Web Storage API (строки, синхронность, привязка к origin, ~5 МБ)',
      },
      {
        name: 'Одинаковый API: setItem, getItem, removeItem, clear',
      },
      {
        name: 'Различия: время жизни и область видимости между вкладками',
      },
      {
        name: 'Когда использовать: localStorage — настройки, sessionStorage — состояние вкладки',
      },
      {
        name: 'Безопасность: XSS, токены — в HttpOnly cookies',
      },
      {
        name: 'Альтернативы: Cookies и IndexedDB',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Мутация — изменение «на месте», иммутабельность — новая копия',
      },
      {
        name: 'Переменная хранит ссылку: мутация видна всем держателям ссылки',
      },
      {
        name: 'Методы массивов: мутирующие (push, splice, sort) vs новые (map, filter, slice)',
      },
      {
        name: 'ES2023: toSorted, toReversed, toSpliced, with',
      },
      {
        name: 'Иммутабельное обновление: spread, map, filter',
      },
      {
        name: 'Зачем: предсказуемость и сравнение по ссылке (React, OnPush, Redux)',
      },
      {
        name: 'const не защищает содержимое; Object.freeze — поверхностный',
      }
    ]
  },
  {
    id: 65,
    name: 'Модули в JavaScript: CommonJS vs ES Modules (import/export). В чем разница?',
    answer: 'assets/content/rus/answers/65-Moduli-v-JavaScript-ESM-vs-CommonJS.md',
    tags: [
      'JavaScript',
      'JS mechanics',
      'ES6',
    ...
    structure: [
      {
        name: 'Зачем модули: своя область видимости и явный граф зависимостей',
      },
      {
        name: 'CommonJS: require/module.exports — функция в рантайме, синхронно',
      },
      {
        name: 'ES Modules: import/export — статический синтаксис, граф до выполнения',
      },
      {
        name: 'Ключевые различия: момент разрешения, live bindings vs копия, sync vs async',
      },
      {
        name: 'Tree shaking — следствие статической структуры ESM',
      },
      {
        name: 'Dynamic import() и code splitting',
      },
    ]
  },
  {
    ...
    structure: [
      {
        name: 'Observable — ленивая обёртка над функцией, поток значений во времени',
      },
      {
        name: 'Контракт: next, error, complete',
      },
      {
        name: 'Чем отличается от Promise: лень, много значений, отмена',
      },
      {
        name: 'Subscription и unsubscribe: кто завершается сам, а кого закрываем мы',
      },
      {
        name: 'Утечка памяти из-за забытой подписки: async pipe и takeUntilDestroyed',
      }
    ]
  },
  {
  ...
  {
    id: 81,
    name: 'Debounce и Throttle. В чем разница и когда что применять?',
    answer: 'assets/content/rus/answers/81-Debounce-i-Throttle.md',
    tags: [
      'JavaScript',
      'JS mechanics',
      'functions',
    ...
    structure: [
      {
        name: 'Debounce ждёт тишины, throttle держит ритм',
      },
      {
        name: 'Реализация debounce и throttle на замыкании и таймере',
      },
      {
        name: 'Когда что применять: итог или процесс',
      },
      {
        name: 'Ловушка: обёртку создают один раз',
      }
    ]
  },
  {
  ...
  {
    id: 87,
    name: 'Метод оценки сложности алгоритма: O(n), O(n^2), O(log n), O(n log n) и т.д. Что это и зачем нужно?',
    ...
    structure: [
      {
        name: 'Что такое Big O Notation?',
      },
      {
        name: 'Как оценивать временную сложность (Time Complexity) - O(n), O(n^2), O(log n), O(n log n)',
      },
      {
        name: 'Как оценивать пространственную сложность (Space Complexity)? - O(1), O(n), O(log n)',
      },
      {
        name: 'Правила сложения и умножения в Big O',
      }
    ]
  },
  {
  ...
  {
    id: 91,
    name: 'Реактивное программирование и RxJS. Асинхронность через потоки данных',
    ...
    structure: [
      {
        name: 'Реактивное программирование: данные — асинхронные потоки во времени',
      },
      {
        name: 'Push vs Pull: Observable против функций, итераторов и Promise',
      },
      {
        name: 'Какие проблемы решает RxJS: множественность, отмена, композиция, состояние',
      },
      {
        name: 'Базовые сущности: Observable, Observer, Subscription, Subject',
      },
      {
        name: 'Операторы и pipe(): семьи операторов',
      }
    ]
  },
  {
  ...
  {
    id: 100,
    name: 'Deferrable Views (@defer): Как работает этот механизм и какие встроенные триггеры существуют?',
    answer: 'assets/content/rus/answers/100-Deferrable-Views-defer.md',
    tags: [
      'Angular',
      'Performance'
    ],
    ...
    structure: [
      {
        name: 'Deferrable Views - что это и для чего нужно?',
      },
      {
        name: 'Встроенные триггеры для @defer',
      },
      {
        name: 'Как @defer работает под капотом',
      }
    ]
  },
  {
  ...
  {
    id: 109,
    name: 'Чистая функция (Pure Function) и её преимущества. Ссылочная прозрачность (Referential Transparency)',
  ...
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Примеры Higher-Order Functions в JavaScript (map, filter, reduce, sort и т.д.)',
      }
    ]
  },
  {
  ...
  },
  {
    ...
    structure: [
      {
        name: 'Сервисы в Angular - что это такое, для чего нужны и какие проблемы решают',
      },
      {
        name: 'Жизненный цикл сервисов в Angular',
      },
      {
        name: 'Какие бывают способы подключения сервисов в Angular',
      }
    ]
  },
  {
    ...
    structure: [
      ...
      {
        name: 'Синглтоны подветви роутов в Standalone-компонентах',
      }
    ]
  },
  {
  ...
  {
    id: 172,
    name: 'SemVer (Semantic Versioning). В чем разница между Major, Minor и Patch версиями? ^ vs ~ в package.json',
    answer: 'assets/content/rus/answers/172-SemVer.md',
    tags: [
      'JavaScript',
      'SemVer',
      'Versioning',
    ...
    structure: [
      {
        name: 'Что такое SemVer и как он используется для управления версиями в JavaScript?',
      },
      {
        name: 'В чем разница между Major, Minor и Patch версиями в SemVer?',
      },
      {
        name: 'Как работают символы ^ и ~ в package.json и какие версии они позволяют устанавливать?',
      }
    ]
  },
  {
    id: 173,
    name: 'Жадные вычисления (Eager Evaluation) vs Ленивые вычисления (Lazy Evaluation). В чем разница и когда какой подход использовать?',
    answer: 'assets/content/rus/answers/173-Eager-vs-Lazy.md',
    tags: [
      'JavaScript',
      'Eager Evaluation',
      'Lazy Evaluation',
    ...
    structure: [
      {
        name: 'Что такое жадные вычисления (Eager Evaluation) и ленивые вычисления (Lazy Evaluation) в JavaScript?',
      },
      {
        name: 'В чем разница между этими подходами и когда какой использовать?',
      }
    ]
  }
] as Question[];
